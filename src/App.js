...
function App() {
  return (
    <div class="min-w-64 w-1/2 my-20 mx-auto text-center font-sans bg-orange-100 rounded shadow-lg pb-4" style={{fontFamily: 'DM Sans'}}>
      <img src="https://cloud-dr0rikspp-hack-club-bot.vercel.app/0untitled_design__1_.png" alt="Mountain at sunset in Olympia, Washington" class="w-full object-cover rounded-t shadow-lg" />
      ...
      <div className="section-nav" class="m-8">
          <a href="https://firebreather65.github.io/hc-workshop-wonderland/" target="_blank" class="inline-block align-middle ml-4">
